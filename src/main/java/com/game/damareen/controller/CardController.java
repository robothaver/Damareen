...
public class CardController {
    ...
    public ResponseEntity<WorldCard> createWorldCard(
            @Valid @RequestBody WorldCardCreateRequest request,
            @Valid @NotBlank @PathVariable String player) {
    ...
    public ResponseEntity<LeadCard> createLeadCard(
            @Valid @RequestBody CreateLeadCardRequest request,
            @Valid @NotBlank @PathVariable String player) {
        long playerId = playerHelperService.createPlayerIfNotExists(player);
